...
[![GitHub Stars](https://img.shields.io/github/stars/coti-io/coti-dsp-node.svg)](https://github.com/coti-io/coti-dsp-node/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/coti-io/coti-dsp-node.svg)](https://github.com/coti-io/coti-dsp-node/issues)
[![Current Version](https://img.shields.io/badge/version-1.5.0.RELEASE-green.svg)](https://github.com/coti-io/coti-dsp-node/)
...
java -jar dspnode/target/dspnode-1.5.0.RELEASE.jar --spring.config.additional-location=dsp1.properties
```
#### Docker container
